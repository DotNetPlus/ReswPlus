...
This is opt-in so that existing apps keep the behavior they were built against. Apps that let users pick a language in-app, through `ApplicationLanguages.PrimaryLanguageOverride`, should turn it on.
