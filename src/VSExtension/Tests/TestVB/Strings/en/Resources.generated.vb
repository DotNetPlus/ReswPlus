...
Public Class Resources
    ...
    Public Shared ReadOnly Property TestFormatWithMacro As String
        Get
            Return _resourceLoader.GetString("TestFormatWithMacro")
        End Get
    End Property

    ' <summary>
    '   Format the string similar to: These '{0}', '{1}', '{2}' are string generated by a macros
    ' </summary>
    Public Shared Function TestFormatWithMacro_Format() As String
        Return String.Format(TestFormatWithMacro, ReswPlusLib.Macros.AppVersionFull, ReswPlusLib.Macros.LocaleName, ReswPlusLib.Macros.ShortDate)
    End Function
    #End Region
